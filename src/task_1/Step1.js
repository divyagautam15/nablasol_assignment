    ...
    return (
        <>
            ...
            <div>
                ...
                <textarea className="form-control textarea-height" style={(props.errors.notes && props.touched.notes) ? { border: "1px solid red" } : {}} name='notes' value={props.values.notes} onChange={props.handleChange} onBlur={props.handleBlur} placeholder="Type here..." />
            </div>
        </>
    );
};
